            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if(mSensorStepDetector!=null){
                        mSensorManager.registerListener(listener, mSensorStepDetector,
...
class StepCounterListener implements SensorEventListener {
    ...
    public static int mStepDetectorCounter = 0;
    ...
    //TODO 10
    public StepCounterListener(TextView stepsCountTextView, ProgressBar progressBar){
    ...
    private void countSteps(float step) {
        mStepDetectorCounter += 1;
        progressBar.setProgress(StepCounterListener.mStepDetectorCounter);
        stepsCountTextView.setText(String.valueOf(mStepDetectorCounter));
